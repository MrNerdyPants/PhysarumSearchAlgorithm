...
//        Logger.getLogger("org").setLevel(Level.SEVERE)
    ...
    val pop: Int = Math.floor(4 + Math.floor(3 * Math.log(dim))).round.toInt//scala.io.StdIn.readLine.toInt//args(0).toInt//scala.io.StdIn.readLine.toInt//
    ...
    var selection: Int = 50 //scala.io.StdIn.readLine.toInt//args(5).toInt//scala.io.StdIn.readLine.toInt//
