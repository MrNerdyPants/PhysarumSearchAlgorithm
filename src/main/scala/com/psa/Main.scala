...
//        Logger.getLogger("org").setLevel(Level.SEVERE)
    ...
    val pop: Int = 50
//        Math.floor(4 + Math.floor(3 * Math.log(dim))).round.toInt//scala.io.StdIn.readLine.toInt//args(0).toInt//scala.io.StdIn.readLine.toInt//
    ...
    val max: Double = 500 //scala.io.StdIn.readLine.toDouble//args(3).toDouble//scala.io.StdIn.readLine.toDouble//
